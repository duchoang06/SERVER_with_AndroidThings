package com.duchoang.serverproject;
...
public class MainActivity extends Activity {
    ...
    private String[] memberIDList = {"1610755         ", "1613333         ", "1611111         ", "1612222         "};
    ...
    private class RfidWriteTask extends AsyncTask<Object, Object, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            ...
            writeToRFID("Duc", "18/03/1998", "1610755", address_name, address_dob, address_id);
    ...
    private void writeToRFID(String Name, String DOB, String ID, byte blockName, byte blockDOB, byte blockID){
        ...
        try {
            ...
            if (!result) {
                mTagResultsView.setText(R.string.authentication_error);
                mStatus.setText(R.string.fail);
                return;
            }
    ...
    public String removeBar(String str) {
        String temp = "";
